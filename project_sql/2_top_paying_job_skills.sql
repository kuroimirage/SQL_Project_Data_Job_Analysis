...
- Why? It provides a detailed look at which high-paying jobs demand certain skills,
    helping understand which skills to develop that align with top salaries.
*/

-- Modified Query 1 CTE (top paying jobs)
...
/*
Breakdown of most demanded skills from these 15 job postings:
SQL – Mentioned 10 times in job postings.
Python – Mentioned 9 times.
Tableau – Mentioned 6 times.
Other skills such as Azure, R, Excel, Pandas, Snowflake, Go, Power BI – 
    Each appears with varying degrees of demand.
